...
def get_question_after(question_id = 0, quiz_id=1):#возвращает слещий вопрос после вопроса с переданным id ддля первого вопроса передаётся значение по умолчаниюую    
    open()
    query = '''
